 ...
 */
final class Version20210413173407 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE bill (id INT NOT NULL, from_id INT NOT NULL, to_id INT NOT NULL, value INT NOT NULL, description VARCHAR(255) NOT NULL, settled BOOLEAN NOT NULL, PRIMARY KEY(id))');
