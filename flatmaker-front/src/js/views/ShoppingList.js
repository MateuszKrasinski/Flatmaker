...
import {postHelp, removeHelp, userHelps} from "../api/Api";
                            ...
                            projects['helps'].map((tech) => {
                                return (
                                    <div id={tech['id']} className={"item"}>
                                        <span>{tech['name']}</span>
                                        <FontAwesomeIcon icon={faMoneyBillAlt}  id={tech['id']} onClick={(e) => removedHelp(tech['id'])}/>
                                        <FontAwesomeIcon icon={faCheckCircle} id={tech['id']} onClick={(e) => removedHelp(tech['id'])}/>
